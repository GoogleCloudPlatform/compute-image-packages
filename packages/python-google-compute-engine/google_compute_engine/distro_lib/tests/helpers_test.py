...
class HelpersTest(unittest.TestCase):
  ...
  def testCallDhclientIpv6(self, mock_call, mock_exists):
    ...
    expected_calls = [
        mock.call.call(
            ['dhclient', '-sf', 'test_script', '-1', '-6', '-v', 'a', 'b']),
        mock.call.call(['dhclient', '-1', '-6', '-v', 'c', 'd']),
        mock.call.call(['dhclient', '-1', '-6', '-v', 'e', 'f']),
        mock.call.call(['dhclient', '-1', '-6', '-r', '-v', 'g', 'h']),
        mock.call.call(['dhclient', '-1', '-6', '-r', '-v', 'i', 'j']),
        mock.call.call(['dhclient', '-1', '-6', '-r', '-v', 'k', 'l']),
    ]
