...
sudo rm -f /etc/init.d/google-accounts-manager
sudo rm -f /etc/init.d/google-address-manager
sudo rm -f /etc/init.d/google-clock-sync-manager
...
sudo rm -f /etc/init.d/google
sudo rm -f /etc/init.d/google-startup-scripts

sudo rm -f /etc/rsyslog.d/90-google.conf
sudo rm -f /etc/sysctl.d/11-gce-network-security.conf

sudo rm -f /lib/udev/rules.d/64-gce-disk-removal.rules
sudo rm -f /lib/udev/rules.d/65-gce-disk-naming.rules
